      ...
      <SplashContainer>
        ...
        <div className="inner">
          ...
          <PromoSection>
            ...
            <Button href={docUrl('d2s-services')}>Start services</Button>
          </PromoSection>
        </div>
      </SplashContainer>
    );
  ...
  render() {
    ...
    const Demo = () => (
      <div
        className="productShowcaseSection paddingBottom"
        style={{textAlign: 'center'}}>
          <script id="asciicast-Hd5C0Y281g3cBFHVjvveymY6r" height='300px' 
            src="https://asciinema.org/a/Hd5C0Y281g3cBFHVjvveymY6r.js" 
        ...
        {[
          {
            content:
              ...
              '[Web UI](/docs/services-webui#into-the-graph), [Jupyter Notebooks](/docs/services-utilities#jupyter-notebooks)) to access your data 🔭',
